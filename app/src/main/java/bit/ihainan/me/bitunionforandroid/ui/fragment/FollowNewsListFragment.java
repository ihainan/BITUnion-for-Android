...
import bit.ihainan.me.bitunionforandroid.adapters.FollowNewsListAdapter;
 ...
 * 关注列表
 */
public class FollowNewsListFragment extends Fragment {
    ...
    private List<bit.ihainan.me.bitunionforandroid.models.ThreadReply> mList = new ArrayList<>();
    private FollowNewsListAdapter mAdapter;
    ...
    private void setupRecyclerView() {
        ...
        // Adapter
        mAdapter = new FollowNewsListAdapter(mContext, mList);
    ...
    private void refreshData(final long from, final long to) {
        ExtraApi.getFollowNewsList(mContext, from, to,
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (ExtraApi.checkStatus(response)) {
                            try {
                                ...
                                List<ThreadReply> newList = BUApi.MAPPER.readValue(newListJson.toString(),
                                ...
                                CommonUtils.debugToast(mContext, "Loaded " + newList.size() + " more item(s)");
                                ...
                                // 判断是否到头
                                if (newList.size() == Global.LOADING_FAVORITES_COUNT) {
                                    mIsLoading = false;
                                }
                            } catch (Exception e) {
