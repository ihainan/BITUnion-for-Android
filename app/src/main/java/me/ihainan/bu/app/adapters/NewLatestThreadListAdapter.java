...
class NewLatestThreadListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_DEFAULT:
                ...
                viewHolder = new TimelineViewHolder.TimelinePostViewHolder(view);
                break;
            default:
    ...
    private void fillDefaultView(final LatestThread latestThread, RecyclerView.ViewHolder viewHolder) {
        final TimelineViewHolder.TimelinePostViewHolder holder = (TimelineViewHolder.TimelinePostViewHolder) viewHolder;
        ...
        // 发帖、回帖日期
        if (latestThread.lastreply != null && latestThread.lastreply.what != null) {
            ...
            String htmlContent = HtmlUtil.getSummaryOfMessage(HtmlUtil.formatHtml(CommonUtils.decode(latestThread.lastreply.what)));
            holder.content.setText(htmlContent);
        } else {
